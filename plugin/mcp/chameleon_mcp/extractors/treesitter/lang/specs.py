...
GO: Final = LanguageSpec(
    ...
    # A grouped `import ( ... )` nests its specs; without the descent the whole
    # parenthesized block reads as one module path.
    import_descend_nodes=("import_spec_list",),
...
PHP: Final = LanguageSpec(
    ...
    call_nodes=("member_call_expression", "scoped_call_expression"),
