...
See `docs/architecture.md#versioning-and-schema-migrations` for the complete
...
`v<from>_to_<to>.py`, e.g. `v3_to_v4.py`. A migration applies cleanly when
...
v7-to-v8 bump (cluster-signature metric change) intentionally ships no migration:
