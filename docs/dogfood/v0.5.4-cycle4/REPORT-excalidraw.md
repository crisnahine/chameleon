...
- `[.]` **shape=monorepo-ts** — file_count_approx=1504
- `[.]` **has_gemfile=False**
- `[.]` **has_pkgjson=True**
- `[.]` **has_monorepo=True**
...
- `[+]` **bootstrap_repo status=success** — in 7.8s, archetypes=4, files=629
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[.]` **no language_hint (single-language repo)**
- `[+]` **naming quality: 0/4 are cluster-<hash>**
...
- `[+]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T14:30:56Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778509796-4cf1', 'idiom-2026-05-11-1778509796-516a'] ...
...
- `[!]` **get_canonical_excerpt empty content** — {"status": "failed", "error": "archetype not found", "archetype_name": "action", "repo_id": "e25d5aae975b96dbca023afee65
