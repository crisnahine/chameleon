# Dogfood report: mastodon

- App path: `/Users/crisn/Documents/Projects/Testing Apps/mastodon`
...
- `[.]` **shape=rails-with-frontend** — file_count_approx=10683
- `[.]` **has_gemfile=True**
- `[.]` **has_pkgjson=True**
- `[.]` **has_monorepo=False**
...
- `[+]` **bootstrap_repo status=success** — in 4.5s, archetypes=146, files=3178
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[+]` **language_hint emitted (hybrid repo detected)** — primary=ruby, secondary=typescript, secondary_file_count=829
- `[+]` **naming quality: 1/146 are cluster-<hash>**
- `[+]` **paths_pattern_display present on 146 archetypes (v0.5.2 Rails fix)**
...
- `[+]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T14:30:53Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778509793-2bf6', 'idiom-2026-05-11-1778509793-5cce'] ...
- `[+]` **Bug 3: list_profiles carries repo_root + archetype_count**
- `[+]` **Bug 4: get_drift_status(path) resolves to repo_id hex** — repo_id=d4fbbf2fdfff..., keys=['days_since_refresh', 'observed_drift_score', 'recommended_action', 'repo_id']
...
- `[+]` **get_pattern_context returned** — top_keys=['api_version', 'data'], data_keys=['archetype', 'canonical_excerpt', 'idioms', 'meta', 'repo', 'rules'], file=vitest.shims.d.ts
- `[+]` **get_archetype(class) returned** — content_signal=None
- `[!]` **get_canonical_excerpt empty content** — {"status": "failed", "error": "archetype not found", "archetype_name": "class", "repo_id": "d4fbbf2fdfff131189be0363357c
...
- `[+]` **refresh_repo status='noop'** — {"status": "noop", "reason": "no files changed since last refresh", "archetypes_detected": 146, "files_processed": 3178, "duration_ms": 0, "profile_path": "/Users/crisn/Documents/Projects/Testing Apps
