...
- `[.]` **shape=rails-with-frontend** — file_count_approx=7826
- `[.]` **has_gemfile=True**
- `[.]` **has_pkgjson=True**
- `[.]` **has_monorepo=False**
...
- `[+]` **bootstrap_repo status=success** — in 4.6s, archetypes=127, files=3514
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[+]` **language_hint emitted (hybrid repo detected)** — primary=ruby, secondary=typescript, secondary_file_count=591
...
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778509793-052a', 'idiom-2026-05-11-1778509793-5232'] ...
