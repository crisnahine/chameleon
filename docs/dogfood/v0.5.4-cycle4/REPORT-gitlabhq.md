...
- `[.]` **shape=rails-only** — file_count_approx=78508
- `[.]` **has_gemfile=True**
- `[.]` **has_pkgjson=True**
- `[.]` **has_monorepo=False**
...
- `[+]` **bootstrap_repo status=success** — in 34.5s, archetypes=1197, files=28789
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[+]` **language_hint emitted (hybrid repo detected)** — primary=ruby, secondary=typescript, secondary_file_count=2646
- `[+]` **naming quality: 4/1197 are cluster-<hash>**
- `[+]` **paths_pattern_display present on 1197 archetypes (v0.5.2 Rails fix)**
...
- `[+]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T14:31:24Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778509824-2877', 'idiom-2026-05-11-1778509824-8b0b'] ...
...
- `[+]` **get_canonical_excerpt(class) returned content** — 501 bytes
...
- `[+]` **refresh_repo status='noop'** — {"status": "noop", "reason": "no files changed since last refresh", "archetypes_detected": 1197, "files_processed": 28789, "duration_ms": 0, "profile_path": "/Users/crisn/Documents/Projects/Testing Ap
