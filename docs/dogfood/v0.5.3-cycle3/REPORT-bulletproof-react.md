...
- `[+]` **bootstrap_repo status=success** — in 0.8s, archetypes=12, files=447
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[.]` **no language_hint (single-language repo)**
- `[!]` **naming quality: 6/12 are cluster-<hash>**
...
- `[!]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T13:50:58Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778507398-1439', 'idiom-2026-05-11-1778507398-26ee'] ...
...
- `[+]` **get_archetype(cluster-27db5a37) returned** — content_signal=None
- `[+]` **get_canonical_excerpt(cluster-27db5a37) returned content** — 1253 bytes
- `[+]` **get_rules(cluster-27db5a37) returned** — ['rules']
