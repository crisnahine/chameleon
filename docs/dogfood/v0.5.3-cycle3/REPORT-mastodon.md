...
- `[+]` **bootstrap_repo status=success** — in 4.4s, archetypes=146, files=3178
...
- `[!]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T13:51:02Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778507402-2348', 'idiom-2026-05-11-1778507402-2365'] ...
