...
- `[.]` **shape=monorepo-ts** — file_count_approx=6329
- `[.]` **has_gemfile=False**
- `[.]` **has_pkgjson=True**
- `[.]` **has_monorepo=True**
...
- `[+]` **bootstrap_repo status=success** — in 14.9s, archetypes=70, files=3581
- `[+]` **profile.json present**
- `[+]` **profile.json schema_version == 7 (v0.5.2)**
- `[.]` **no language_hint (single-language repo)**
- `[!]` **naming quality: 35/70 are cluster-<hash>**
...
- `[!]` **Bug 1: pause_session(repo_id) accepts hex digest** — {"status": "success", "expires_at": "2026-05-11T12:25:48Z", "minutes": 1}
- `[+]` **Bug 2: 5 same-second teaches produced 5 unique slugs** — ['idiom-2026-05-11-1778502288-48c6', 'idiom-2026-05-11-1778502288-6a2a'] ...
...
- `[+]` **get_archetype(cluster-000c659d) returned** — content_signal=None
- `[!]` **get_canonical_excerpt empty content** — {"content": "", "witness_path": null, "truncated": false, "sha_hint": null}
- `[+]` **get_rules(cluster-000c659d) returned** — ['rules']
