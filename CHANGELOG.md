...
- **`no-personal-paths` CI check failed on main.** A `chameleon-teach`
  skill example used a home-directory path segment the check's placeholder
  allowlist doesn't recognize. Swapped to the `you` placeholder already
