...
If any of the 9 hashed profile artifacts (`.archetype_renames.json`, `archetypes.json`, `canonicals.json`, `config.json`, `conventions.json`, `principles.md`, `idioms.md`, `profile.json`, `rules.json`) have changed since trust was granted, trust becomes stale and the user must re-confirm.
