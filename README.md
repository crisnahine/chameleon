...
[![Tests](https://img.shields.io/badge/unit%20tests-6%2C861-blue.svg)](#proof-not-promises)
...
|---|---|---|
| Unit tests | **6,861** | `PYTHONPATH=. plugin/mcp/.venv/bin/python -m pytest tests/unit/ --co -q` |
